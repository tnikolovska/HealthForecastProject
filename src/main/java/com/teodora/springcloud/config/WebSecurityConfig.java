...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
   ...
   @Override
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/userhealthconditionsymptomapi/user-health-condition").hasAuthority("ROLE_USER")
        .antMatchers("/userhealthconditionsymptomapi/determine-user-health").hasAuthority("ROLE_USER")
